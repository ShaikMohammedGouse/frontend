from flask import Flask, request, jsonify,Response,Markup
...
def predict():
    ...
    test_image= plt.imread("E:/home/lenovo/pdp-project/Backend/static/" + filename)  

    test_image="E:/home/lenovo/pdp-project/Backend/static/" + filename
    img = Image.open(image)  
 ...
 #   return jsonify({'class_label': str(class_label)})
 
 #   return jsonify({class_label_str})
...
def predict_image(image_file, img_size):
    ...
    model = tf.keras.models.load_model('home/lenovo/pdp-project/Backend/LeafNonLaef.hdf5')
